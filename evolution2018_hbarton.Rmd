...
* Regions adjacent to exons have reduced INDEL diversity - genetic hitch-hiking
* Extends over relatively large distance 0-100kb
* Also areas of low recombination show reduced diversity

## Next steps

* Intersting to investigate if reduced diversity is is due to postive selection or purrifying selection
